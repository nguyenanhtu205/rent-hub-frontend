  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-sky-50 via-white to-amber-50'>
      ...
      <div className='relative flex'>
        {/* Sidebar */}
        <aside className='sticky top-0 hidden h-screen w-72 shrink-0 border-r border-sky-100/60 bg-white/70 p-6 backdrop-blur-xl lg:block'>
          ...
          <nav className='mt-10 space-y-1.5'>
            <MenuItem icon={<Home size={18} />} label='Dashboard ký gửi' active />
